...
export function BaseLayout() {
    ...
    const handleOnClickExpandedMenu = () => {
        setExpandedMenu((prevExpand) => !prevExpand)
    }
    ...
    return (
        ...
        <div className="min-h-full">
            <nav className="bg-gray-800">
                    ...
                    <div className="flex h-16 items-center justify-between">
                        ...
                        <div className="hidden md:block">
                            <div className="ml-4 flex items-center md:ml-6">
                                ...
                                <button type="button" onClick={handleClick} className="rounded-full bg-gray-800 p-1 text-gray-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
                                ...
                                <div className="relative ml-3">
                                    <div>
                                        <button type="button" onClick={handleOnClickExpandedMenu} className="flex max-w-xs items-center rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
                                    ...
                                    <div style={ expandedMenu ? { display:'block'} : {display : 'none'} } className="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button" tabIndex={-1}>
                        ...
                        <div className="-mr-2 flex md:hidden">
                            <button type="button" onClick={handleClick} className="inline-flex items-center justify-center rounded-md mr-1 bg-gray-800 p-1 text-gray-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
                                <span className="sr-only">Dark Mode</span>
                                {svg}
                            </button>
                ...
                <div className="md:hidden" id="mobile-menu" style={ menuMobile ? { display:'block'} : {display : 'none'} }>
